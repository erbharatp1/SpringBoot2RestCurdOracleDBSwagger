...
public class SpringBoot2RestCurdOracleDBSwaggerApplicationTests {

	private Logger log = LoggerFactory.getLogger(SpringBoot2RestCurdOracleDBSwaggerApplicationTests.class);
